...
const wazaDamageTable = {
    ...
    "逆天秤": 20, "腕逆捕": 15,
    "振突中段二連": 10, "上上二連": 10, "振突二連": 10,
    "振突逆突二連": 10,
    
    // 新規追加技（威力はすべて強力な15に設定）
    "上中二連": 10, "突天一": 10,
    "上中上三連": 15, "上中蹴三連": 15, "突天三": 15, "蹴天三": 15,
    "一本背投": 20, "諸手輪抜": 15, "諸手巻抜": 15, "押小手": 20,

    "腕十字固": 10, "腕十字固より立合掌固": 15, "小手抜": 5, "逆小手より裏固": 15,
    ...
    "屈伸突": 10, "屈伸突蹴": 15,
    "切抜（外）": 5, "切抜（内）": 5, "十字抜": 5, "十字小手": 15, "横転身蹴": 10, "半転身蹴": 10,
    "十字受蹴": 15, "払受蹴": 15, "金的蹴膝受波返": 15, "下受蹴": 10, "下受順蹴": 10, "逆転身蹴": 15,
    "切返抜": 10, "切小手": 15, "三角抜": 10, "片手押抜": 10, "片胸落": 15, "襟十字": 15,
    "上膊抜": 10, "上膊捕": 15, "押切抜": 10,
    "袖抜": 10, "袖捕": 15, "袖巻": 10, "袖巻天秤": 15, "襟抜": 10, "腕巻": 15, "小手巻返": 15,
    "諸手押抜": 10, "諸手十字小手": 15, "諸手引抜": 15, "巻小手": 15,
    "混天一": 10, "突天二": 10, "振天二": 10,
};
...
const battleDatabase = {
    "中段構え_中段構え": {
        ...
        checkSuccess: (atk, def) => {
            ...
            // 通常技判定
            if (atk === "内手首掴む" && ["腕十字固", "小手抜"].includes(baseDef)) return true;
